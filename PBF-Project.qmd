...
Using boxplots (@fig-box) allow us to focus on the distribution of values, obtaining a clearer visualization of the overall trend.

```{r tmelt boxplot}
#| label: fig-box
#| fig-cap: "This version of the boxplot, introduced by E. Tufte in 'Visual Display of Quantitative Information' (2001), is interpreted in the following manner: a point represent the median, while the white interval around it represent the IQR. The black lines are the whiskers of the boxplot, extending to 3/2 times the IQR."
#| fig-widh: 12
#| fig-height: 7
#| warning: false
tmelt %>% 
  ...
  scale_y_log10() +
  labs(
    title = "Tourism Time Series: Boxplots",
    x = "Year",
    y = expression(log[10](Value))
  ) +
  theme(
