...
#' 
## ----checking dimensions and NA 1---------------------------------------------
data_main %>% 
  dim

#' 
## ----checkig dimensions and NA 2----------------------------------------------
data_main %>% 
  is.na() %>% 
  sum
...
#' 
## ----NAIVE validation forecasts fable-----------------------------------------
naive_fc <- 
  naive_model %>% 
  forecast(
    h = 4
...
#' 
## ----NAIVE validation forecasts fable tail------------------------------------
naive_fc %>% 
  tail(20)
...
#' ### Comparison Table
#' 
## ----prettyprint MAPEs comparison table---------------------------------------
...
#' ### Comparison Table:
#' 
## ----prettyprint MASEs comparison table---------------------------------------
